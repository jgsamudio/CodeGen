...
extension CodeGenerator {
    ...
    func insertStringFound(fileComponents: [String], sourceLocation: SourceLocation) -> Bool {
        return generatorConfig.insertString?.isEqual(toBottomOf: Array(fileComponents[0..<sourceLocation.index])) ?? false
    }
