//
//  LeaderboardListItemOnlineQualifier.swift
//  CrossFit Games
//
...
/// Leaderboard list item for the online qualifier competition.
struct LeaderboardListItemOnlineQualifier: LeaderboardListItem, Decodable {
