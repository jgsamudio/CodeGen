//
//  OpenLeaderboardListTests.swift
//  CrossFit GamesTests
//
...
class OpenLeaderboardListTests: XCTestCase {

    func testParsingLeaderboards() {
        guard let filePath = Bundle(for: OpenLeaderboardListTests.self).url(forResource: "leaderboard_open", withExtension: "json"),
